...
<body>
<table class="tablelist" style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 35px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
  <tr>
    <td style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px">
	<form id="myform2" name="myform1" method="post" action="managecpbiginfo.php?titleID=<?php echo $titleID;?>" onsubmit="return checkSo();">
...
<br />
<table class="tablelist" border=0 cellSpacing=0 cellPadding=0 width="98%" align=center style="font-size:12px">
  <tr bgColor=#7691c7>
    <td height="49" bgcolor="#FFFFFF"><form id="myform" name="myform" method="post" action="savecpbiginfo.php?action=del&amp;titleID=<?php echo $titleID;?>">
      <table class="tablelist" width="100%" height="49" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 {
		?>
              <table class="tablelist" style="BORDER-COLLAPSE: collapse" border=1 cellSpacing=0 borderColor=#c9d3e9 cellPadding=0 width="100%" align=center style="font-size:12px">
                <tr align="center" height=25 bgColor=#e3e8f3>
                    <td align="center">序号</td>
                    <td align="center">信息标题</td>
                    <td width="10%" align="center">信息类型</td>
			  ...
			  ?>
				  ...
				  ?>                    </td>
					...
					<a href="editcpbiginfo.php?ID=<?php echo $rs["ID"];?>&amp;class_id=<?php echo $rs["class_id"];?>&amp;titleID=<?php echo $titleID;?>">修改</a></div></td>
