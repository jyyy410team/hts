...
<html>
<head>
<title>menu</title>   </title> <LINK rel=stylesheet type=text/css href="../css/style2.css">    
...
<body target="main">
<table class="tablelist" width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
  <tr>
...
//-->
        ...
        <table class="tablelist" width="150" border="0" cellpadding="0" cellspacing="2" class="md" bgcolor="#FFFFFF">
          <tr>
          ...
          <tr id="LM1">
            <td bgcolor="#FFFFFF"><table class="tablelist" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
