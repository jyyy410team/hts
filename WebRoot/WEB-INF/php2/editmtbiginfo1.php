...
<form id="form1" name="form1" method="post" action="savemtbiginfo.php?action=shmt&ID=<?php echo $ID;?>&titleID=<?php echo $titleID;?>" onSubmit="return CheckForm();">
  <table class="tablelist" width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#e2e2e2" style="margin-bottom:8px">
    <tr bgcolor="#EEF4EA">
...
<?php } ?>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><textarea name="content"  style="width:100%;height:230px;visibility:hidden;"><?php echo $rsN["content"];?></textarea></td>
    </tr>
	<tr bgcolor="#FFFFFF">
