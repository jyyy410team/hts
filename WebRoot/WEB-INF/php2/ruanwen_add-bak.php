...
<div class="col-2  col-auto" >
    ...
    <form id="form1" name="form1" method="post" action="action.php?a=rwadd" onsubmit="return check()" style="display:" >
	    <table class="tablelist" width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
	      <tr>
...
<div id="flselect" style="display:none" >
    ...
    <table class="tablelist" width="100%" border="0" cellpadding="0" style="border:1px solid #ccc;padding-bottom:5px;">
  ...
  <br />
    <table class="tablelist" width="100%" cellpadding="0" cellspacing="0" bgcolor="#e2e2e2" >
	      <!--<tr>
            ...
            <table class="tablelist" border="0" cellpadding="5" cellspacing="2">
	          <tr>
...
<table class="tablelist" width="100%" border="0" cellspacing="1" bgcolor="#CCCCCC" id='yixuantr'>
  <tr>
