...
<table class="tablelist" cellSpacing=1 cellPadding=0 width="100%"  style="font-size:13px">
  <TBODY><?php
  ...
  <TR>
	...
	<table class="tablelist" width="100%" border="0" cellspacing="0" cellpadding="2" style="font-size:13px">
            <tr>
