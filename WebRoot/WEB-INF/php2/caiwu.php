...
<HTML>
<HEAD>
<TITLE>后台管理中心</title>  <LINK rel=stylesheet type=text/css href="../css/style2.css">    
...
<table class="tablelist" cellSpacing=1 cellPadding=0 width="100%"  style="font-size:12px">
  <TBODY>
		 <br><table class="tablelist" width=750 border=0 align=center cellpadding=0 cellspacing=0><tr>
