...
<table class="tablelist" cellSpacing=1 cellPadding=0 width="100%" >
  ...
  <TR>
    ...
    bgColor=#ffffff align=left><textarea name="yaoqiu"  style="width:100%;height:330px;visibility:hidden;">1、推广对象：&lt;BR /&gt;
2、文章体裁：&lt;BR /&gt;
3、文章标题：&lt;BR /&gt;
4、宣传要点：&lt;BR /&gt;
5、其他要求：&lt;BR /&gt;
5、软文案例：&lt;br /&gt;若能提供一篇您认为不错的软文链接给我们，对我们的写作方向很有参考作用，写出的文章也能比较达到您预期的要求。&lt;BR /&gt;</textarea>
  ...
  <TR>
    ...
    <SELECT id="pianshu" lang=require onchange=setprice(this.value) name="pianshu"> <OPTION selected value=0>请选择</OPTION> <OPTION value=1>代写1篇50元</OPTION> <OPTION value=2>代写2篇100元</OPTION> <OPTION value=3>代写3篇150元</OPTION> <OPTION value=4>代写4篇200元</OPTION> <OPTION value=5>代写5篇250元</OPTION> <OPTION value=6>代写6篇300元</OPTION> <OPTION value=7>代写7篇350元</OPTION> <OPTION value=8>代写8篇400元</OPTION> <OPTION value=9>代写9篇450元</OPTION> <OPTION value=10>代写10篇500元</OPTION></SELECT></TD></TR>
  <TR>
    <TD bgColor=#ffffff height=30>
