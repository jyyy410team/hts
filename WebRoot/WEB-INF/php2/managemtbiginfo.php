...
<table class="tablelist" border=0 cellSpacing=0 cellPadding=0 width="100%" style="font-size:12px">
  <TBODY>
  <TR>
    <TD>
	  <FORM id="myform2" name="myform1" method="post" action="managemtbiginfo.php" onsubmit="return checkSo();">
      <table class="tablelist" style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 30px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
        <TBODY>
        <TR>
      ...
      <table class="tablelist" class="tableBorder" width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr align="center" >
          <td width="100%" bgcolor="#FFFFFF"><table class="tablelist" width="730" border='0' cellpadding='0' cellspacing='0'>
            <tr>
        ...
        <TR bgColor=#7691c7>
		  ...
		  <form id="myform" name="myform" method="post" action="savemtbiginfo.php?action=del&amp;titleID=media">
			...
			$i=$i+1;
                  ...
                  <tr align="center">
                    <td colspan="12" align="right" bgcolor="#FFFFFF"><table class="tablelist" width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
