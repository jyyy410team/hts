...
<table class="tablelist" width="98%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#e2e2e2">
  <tr>
    ...
    <td height="49" bgcolor="#FFFFFF"><form id="myform" name="myform" method="post" action="savemtbiginfo.php?action=del&amp;titleID=<?php echo $titleID;?>">
      <table class="tablelist" width="100%" height="49" border="0" cellpadding="0" cellspacing="1">
		...
		?>
			  ...
			  ?>
                  <tr align="center" >
                    <td colspan="13" align="right" bgcolor="#FFFFFF"><table class="tablelist" width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
