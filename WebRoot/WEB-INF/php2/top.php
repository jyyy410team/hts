...
<title>top</title>   </title> <LINK rel=stylesheet type=text/css href="../css/style2.css">    
...
<body bgColor='#ffffff'>
<table class="tablelist" width="100%" border="0" cellpadding="0" cellspacing="0" background="skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="skin/images/frame/logo.gif" /></td>
    <td width='80%' align="left" valign="bottom"><table class="tablelist" width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
