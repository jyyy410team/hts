...
<div class="col-2  col-auto" >
	...
	<div class="content">
	  ...
	  <form id="form1" name="form1" method="post" action="savepass.php" onsubmit="return check()">
	    <table class="tablelist" width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#e2e2e2" style="font-size:12px">
	      <!--tr>
	      ...
	      <!--tr>
	        ...
	        <td align="left" bgcolor="#FFFFFF"><input name="AdminPass" type="password" class="txt" id="AdminPass" lang='require' value="<!--?php echo $AdminPass;?>"  size="40" xml:lang="require"/></td>
          </tr-->
　<TR>
