...
<HTML>
<HEAD>
<TITLE>软文价格中心 - 好推手</title>   </title> <LINK rel=stylesheet type=text/css href="../css/style2.css">    
...
<DIV class="content">
<DIV id="flselect">
<table class="tablelist" style="BORDER-BOTTOM: #ccc 1px solid; BORDER-LEFT: #ccc 1px solid; PADDING-BOTTOM: 5px; BORDER-TOP: #ccc 1px solid; BORDER-RIGHT: #ccc 1px solid" border=0 cellPadding=0 width="100%">
  <TBODY>
  <TR>
...
//		$result6=mysql_db_query($dbname,$sql6);
  ...
  <form name="form2" id='searchtrun' style="margin-bottom:20px;">
          <br />
          <table class="tablelist" width="100%" cellpadding="0" cellspacing="0" bgcolor="#e2e2e2" >
            <tr>
              ...
              <td width="94%" align="center" valign="middle" bgcolor="#FFFFFF"><table class="tablelist" border="0" cellpadding="5" cellspacing="2">
                  <tr>
