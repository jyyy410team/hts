...
<title>网站设置</title>   </title> <LINK rel=stylesheet type=text/css href="../css/style2.css">    
...
<body>
<table class="tablelist" width="98%" height="453" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="453"><form id="myform" name="myform" method="post" action="saveSetInfo.php?action=<?php echo $flag?>" onSubmit="return CheckForm();">
      <table class="tablelist" width="98%" height="507" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#e2e2e2" style="margin-bottom:8px">
        <tr bgcolor="#EEF4EA">
