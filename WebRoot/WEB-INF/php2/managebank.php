...
<table class="tablelist" style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 35px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
  ...
  <tr>
    <td height="49" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="savebank.php?action=add" onsubmit="return CheckForm2();">
      <table class="tablelist" class="tableBorder" width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFFFF">
...
<table class="tablelist" border=0 cellSpacing=0 cellPadding=0 width="98%" align=center style="font-size:12px">
  <tr>
    <td height="49" bgcolor="#FFFFFF"><table class="tablelist" width="100%" height="49" border="0" cellpadding="0" cellspacing="1">
      <tr>
		...
		?>
            <table class="tablelist" style="BORDER-COLLAPSE: collapse" border=1 cellSpacing=0 borderColor=#c9d3e9 cellPadding=0 width="100%" align=center style="font-size:12px">
              ...
              <tr align="center" onmouseover="this.bgColor='#FBDFCC';" onmouseout="this.bgColor='#FFFFFF';" height=55>
                <td align="center"><table class="tablelist" border="0" cellpadding="1" cellspacing="1" bgcolor="#CCCCCC">
                  <tr>
