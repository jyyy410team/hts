...
<TABLE cellSpacing=1 cellPadding=5 width="100%" bgColor=#e2e2e2 style="font-size:13px">
  ...
  <TR>
    ...
    <TD bgColor=#ffffff align=left>&nbsp; <INPUT maxLength=10 size=30 name=WIDtotal_fee onFocus="if(Number(this.value)==0){this.value='';}" value="0.01" style="width:113"/>&nbsp; <span>如：112.21</span>
